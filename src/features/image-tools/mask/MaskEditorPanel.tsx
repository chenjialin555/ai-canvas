...
export function MaskEditorPanel(props: Props) {
  ...
  useEffect(() => {
    if (!props.active || !props.imageId) return;
  ...
  return (
    <>
      <div className="image-editor-subbar image-editor-subbar--mask">
        <div className="image-editor-subbar-tools">
          <button type="button" onClick={undo} title="撤销">
            ↶
          </button>
          <button type="button" onClick={redo} title="重做">
            ↷
          </button>
          <span className="image-editor-subbar-divider" />
          <button
            type="button"
