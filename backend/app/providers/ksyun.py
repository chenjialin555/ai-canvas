...
from backend.app.providers.payloads import build_ksyun_payload
...
class KsyunProvider:
    ...
    def generate(self, req: GenerateImageRequest, settings: Settings) -> tuple[str, Any, str]:
        ...
        payload = build_ksyun_payload(req, model)
        api_key = settings.api_key_for_provider("ksyun")
        base = settings.base_url_for_images_provider("ksyun")
